"""
Django settings for muddy_term_3 project.
...
ROOT_URLCONF = 'muddy_term_3.urls'
...
WSGI_APPLICATION = 'muddy_term_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Muddy Term Support <support@muddy-term-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_term_3 API",
    "DESCRIPTION": "API documentation for muddy_term_3 App",
    "VERSION": "v1",
}
